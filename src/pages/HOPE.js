    ...
    <div>
      <div className="main">
        ...
        <div className="column2">
          ...
          >
            <p>
              <strong>This is a message for those standing on the edge.</strong> For those standing in the headlights, waiting for the drugs to fill up your brain, with that bullet loaded gun to your head or that noose around your neck.
            </p>
            <p>
              I want you to know. <strong>You are not alone.</strong> We all make mistakes. We are all mistreated. We all are alone. We all feel pain invisible to others. We all feel like the world has betrayed us, that the world is cruel and evil. You see the world for what it is, and it hurts.
            </p>
            <p>
              But you are not alone. You are not the only one who has felt this way. You are not the only one who has been hurt. You are not the only one who has been betrayed. <em>Give me one chance to convince you...</em>
            </p>
            <p>
